    ...
    <div>
        <Col v-for="i in formInputs" :span="i.span ? i.span : 12">
            <FormItem :prop='i.prop' :label='i.label'>
                ...
                <Input v-else-if="!i.type || i.type ==='textarea'" type="textarea" v-model="formItem[i.prop]" :placeholder="'请填写'+i.label+'...'" :readonly="readonly && i.readonly" :disabled="readonly && i.disabled"></Input>
